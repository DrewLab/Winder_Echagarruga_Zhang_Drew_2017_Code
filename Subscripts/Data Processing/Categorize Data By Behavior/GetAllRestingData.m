function [RestData] = GetAllRestingData(filenames,RestData,dataTypes)
%   function [RestData] = GetAllRestingData(filenames,dataTypes)
%
%   Author: Aaron Winder
...
%         filename = filenames(f,:);
        ...
        Fs = Data.Fs.([dataTypes{dt} '_fs']);
        
        % Expected number of samples for element of dataType
        Expected_length = Data.TrialDur*Fs;
        ...
        for ET = 1:length(Trial_EventTimes)
            ...
            % current loaded file
            Trial_RestVals{ET} = Data.(dataTypes{dt})(:,start_ind:stop_ind);
